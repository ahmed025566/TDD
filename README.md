...
- We have a class called solver which has the following methods A.K.A features:
- **factorial** which takes a positive number and retyrn the factorial of that number.
- **reverse** which take a string and return reversed string.
- **fizzbuzz** takes an integer an return string based on the provided integer.
...
```bash
git clone https://github.com/ahmed025566/TDD.git
```
